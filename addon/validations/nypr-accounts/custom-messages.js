export default {
  ...
  emailNotFound:         email => `We can't find an account for the email ${email}.</br>Please note that email addresses are case sensitive.</br>Need to <a href='/signup'>create an account</a>?`,
